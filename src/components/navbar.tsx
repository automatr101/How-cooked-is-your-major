    ...
    <nav className="fixed top-0 left-0 right-0 z-[100] px-6 py-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex bg-card/50 backdrop-blur-xl border border-border/50 rounded-2xl p-1 gap-1">
          <Link 
            href="/leaderboard"
            className="px-6 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-all"
          >
            Leaderboard
          </Link>
          <Link 
