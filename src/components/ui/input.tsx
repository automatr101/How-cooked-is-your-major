...
export const Input = React.forwardRef<HTMLInputElement, InputProps>(
  ({
    ...
    const _ref = (ref as React.RefObject<HTMLInputElement>) || localRef;
    ...
    return (
      <div className="flex flex-col gap-2 w-full" onClick={() => _ref.current?.focus()}>
        {label && (
        ...
        <div className={clsx(
          "flex items-center duration-150 font-sans transition-all",
          ...
          <input
            className={clsx(
              "w-full inline-flex appearance-none placeholder:text-gray-900 placeholder:opacity-70 outline-none h-full",
